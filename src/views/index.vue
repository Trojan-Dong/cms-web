<template>
    <div>
                ...
                <div class="m-work f-mb20">
                    ...
                    <div class="u-workc row f-clearfix">
                        ...
                        <div class="u-workr f-md-ha col-md-6">
                            <div class="u-workrt">
                                <ul class="f-clearfix">
                                    <li v-for="(recommendItem, recommendIndex) in recommendCate" :key="recommendIndex" v-if=" recommendIndex < 4" @mouseover="handleRecommend(recommendIndex)">
          ...
          <div class="col-md-6 f-mb20" v-for="(normalItem, normalIndex) in normalCate" :key="normalIndex">
            <div class="u-listhome f-md-ha">
              ...
              <div class="u-listhomec">
                <ul>
                  <li class="f-clearfix" v-for="(articleItem, articleIndex) in normalItem.articleList"
                      :key="articleIndex" @click="handeleNavigate(articleItem)">
        ...
        <div class="m-listhome row" v-if="!parityFlag">
          <div class="col-md-6 f-mb20" v-for="(normalItem, normalIndex) in normalCate" :key="normalIndex"
               v-if="normalIndex < normalCate.length - 1">
            <div class="u-listhome f-md-ha">
              <div class="u-listhomet f-clearfix f-mb10">
                <a class="u-listhometl f-db f-fl">{{ normalItem.name }}</a>
                <a class="u-listhometr f-db f-fr" @click="handleNavigate(normalItem, -1)">MORE+</a>
        ...
        <div class="m-jianshe f-mb20 f-pr f-oh" v-if="!parityFlag">
          ...
          <div class="u-jianshe">
            <ul class="f-clearfix">
              <li v-for="(articleItem, articleIndex) in lastNormalCate.articleList" :key="articleIndex"
                  v-if="articleIndex < 2" @click="handeleNavigate(articleItem)">
